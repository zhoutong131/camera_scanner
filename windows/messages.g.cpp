...
namespace camera_scanner {
    ...
    void CameraApi::SetUp(flutter::BinaryMessenger* binary_messenger,
            ...
            : "";
        {
            BasicMessageChannel<> channel(
                binary_messenger,
                "dev.flutter.pigeon.camera_scanner.CameraApi.getAvailableCameras" +
                prepended_suffix,
                &GetCodec());
            if (api != nullptr) {
        ...
        }
        {
            BasicMessageChannel<> channel(
                binary_messenger,
                "dev.flutter.pigeon.camera_scanner.CameraApi.create" + prepended_suffix,
                &GetCodec());
            if (api != nullptr) {
                channel.SetMessageHandler(
                    [api](const EncodableValue& message,
        ...
        }
        {
            BasicMessageChannel<> channel(
                binary_messenger,
                "dev.flutter.pigeon.camera_scanner.CameraApi.initialize" +
                prepended_suffix,
                &GetCodec());
            if (api != nullptr) {
                channel.SetMessageHandler(
                    [api](const EncodableValue& message,
                        const flutter::MessageReply<EncodableValue>& reply) {
                            try {
                                ...
                                const auto& encodable_ratio = args.at(1);
                                ...
                                const float ratio = static_cast<float>(std::get<double>(encodable_ratio));
                                api->Initialize(
                                    camera_id_arg, ratio,[reply](ErrorOr<PlatformSize>&& output) {
                                        if (output.has_error()) {
                                            reply(WrapError(output.error()));
                                            return;
                                        }
        ...
        }
        {
            BasicMessageChannel<> channel(
                binary_messenger,
                "dev.flutter.pigeon.camera_scanner.CameraApi.dispose" +
                prepended_suffix,
                &GetCodec());
            if (api != nullptr) {
                channel.SetMessageHandler(
        ...
        /*{
            BasicMessageChannel<> channel(
                binary_messenger,
                "dev.flutter.pigeon.camera_scanner.CameraApi.takePicture" +
                prepended_suffix,
                &GetCodec());
            if (api != nullptr) {
                channel.SetMessageHandler(
        ...
        }
        {
            BasicMessageChannel<> channel(
                binary_messenger,
                "dev.flutter.pigeon.camera_scanner.CameraApi.startVideoRecording" +
                prepended_suffix,
                &GetCodec());
            if (api != nullptr) {
                channel.SetMessageHandler(
        ...
        }
        {
            BasicMessageChannel<> channel(
                binary_messenger,
                "dev.flutter.pigeon.camera_scanner.CameraApi.stopVideoRecording" +
                prepended_suffix,
                &GetCodec());
            if (api != nullptr) {
                channel.SetMessageHandler(
        ...
        }*/
        {
            BasicMessageChannel<> channel(
                binary_messenger,
                "dev.flutter.pigeon.camera_scanner.CameraApi.pausePreview" +
                prepended_suffix,
                &GetCodec());
            if (api != nullptr) {
                channel.SetMessageHandler(
        ...
        }
        {
            BasicMessageChannel<> channel(
                binary_messenger,
                "dev.flutter.pigeon.camera_scanner.CameraApi.resumePreview" +
                prepended_suffix,
                &GetCodec());
            if (api != nullptr) {
                channel.SetMessageHandler(
    ...
    void CameraEventApi::CameraClosing(
        ...
        const std::string channel_name =
            "dev.flutter.pigeon.camera_scanner.CameraEventApi.cameraClosing" +
    ...
    void CameraEventApi::Error(
        ...
        std::function<void(const FlutterError&)>&& on_error) {
        const std::string channel_name =
            "dev.flutter.pigeon.camera_scanner.CameraEventApi.error" +
            message_channel_suffix_;
        BasicMessageChannel<> channel(binary_messenger_, channel_name, &GetCodec());
    ...
    void CameraEventApi::ScanCode(
        const std::string& code,
        std::function<void(void)>&& on_success,
        std::function<void(const FlutterError&)>&& on_error) {
        const std::string channel_name =
            "dev.flutter.pigeon.camera_scanner.CameraEventApi.onScanCode" +
            message_channel_suffix_;
        BasicMessageChannel<> channel(binary_messenger_, channel_name, &GetCodec());
        EncodableValue encoded_api_arguments = EncodableValue(EncodableList{
            EncodableValue(code),
