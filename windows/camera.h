...
namespace camera_scanner {
    ...
    public:
        ...
        // from this camera.
        virtual camera_scanner::CaptureController* GetCaptureController() = 0;
    ...
    public:
        ...
        virtual void OnScanCode(const std::string& code) override;
        ...
        camera_scanner::CaptureController* GetCaptureController() override {
