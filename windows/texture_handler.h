...
namespace camera_scanner {
    ...
    public:
        TextureHandler(flutter::TextureRegistrar* texture_registrar, CaptureControllerListener*  listener)
            : texture_registrar_(texture_registrar),capture_controller_listener_(listener){}
