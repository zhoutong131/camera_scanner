...
class CameraApi {
  ...
  Future<List<String>> getAvailableCameras() async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.camera_scanner.CameraApi.getAvailableCameras$pigeonVar_messageChannelSuffix';
  ...
  Future<int> create(String cameraName, PlatformMediaSettings settings) async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.camera_scanner.CameraApi.create$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
  ...
  Future<PlatformSize> initialize(int cameraId, {double ratio = 1/4 }) async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.camera_scanner.CameraApi.initialize$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
    ...
    final List<Object?>? pigeonVar_replyList =
        await pigeonVar_channel.send(<Object?>[cameraId,ratio]) as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);
    } else if (pigeonVar_replyList.length > 1) {
      throw PlatformException(
  ...
  Future<void> dispose(int cameraId) async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.camera_scanner.CameraApi.dispose$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
...
abstract class ScanCodeEventApi {
  static const MessageCodec<Object?> pigeonChannelCodec = _PigeonCodec();
  
  void onScan(String code);
  
  static void setUp(ScanCodeEventApi? api, {BinaryMessenger? binaryMessenger,
    ...
    messageChannelSuffix = messageChannelSuffix.isNotEmpty ? '.$messageChannelSuffix' : '';
    {
      final BasicMessageChannel<
          ...
          Object?>(
          'dev.flutter.pigeon.camera_scanner.CameraEventApi.onScanCode$messageChannelSuffix',
          pigeonChannelCodec,
      ...
      if (api == null) {
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          ...
          final String? code = (args[0] as String?);
          try {
            api.onScan(code??"");
  ...
  static void setUp(
        ...
        messageChannelSuffix.isNotEmpty ? '.$messageChannelSuffix' : '';
    {
      final BasicMessageChannel<
          Object?> pigeonVar_channel = BasicMessageChannel<
              Object?>(
          'dev.flutter.pigeon.camera_scanner.CameraEventApi.cameraClosing$messageChannelSuffix',
          pigeonChannelCodec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        pigeonVar_channel.setMessageHandler(null);
    ...
    }
    {
      final BasicMessageChannel<
          Object?> pigeonVar_channel = BasicMessageChannel<
              Object?>(
          'dev.flutter.pigeon.camera_scanner.CameraEventApi.error$messageChannelSuffix',
          pigeonChannelCodec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        pigeonVar_channel.setMessageHandler(null);
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          assert(message != null,
              'Argument for dev.flutter.pigeon.camera_scanner.CameraEventApi.error was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final String? arg_errorMessage = (args[0] as String?);
          assert(arg_errorMessage != null,
              'Argument for dev.flutter.pigeon.camera_scanner.CameraEventApi.error was null, expected non-null String.');
          try {
